...
import VISTA.CUADROS.CCompras;
import VISTA.CUADROS.CVentas;
...
public class Main {
    ...
    * del boton venta*/
    ...
    /*He borrado el copia pega de Main de la ventana Ventas y pongo el del CuadroVentas*/
    public static void Cventas(){
