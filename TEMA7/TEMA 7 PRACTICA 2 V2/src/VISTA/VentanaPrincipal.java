                ...
                try{
                    ...
                    if(rbVenta.isSelected()){
                       /* prepararVentanaParaVenta();*/
                        Main.actualizarStockDespuesDeUnaVenta(Integer.parseInt(tUnidades.getText()));
                        Main.mostrarConfirmacionVenta(tProducto.getText(),Integer.parseInt(tUnidades.getText()),Float.parseFloat(tPrecioVenta.getText()));
                    }
                }catch (Exception h){
